...
|             **[D.1.4]** <span style="color: #FF0000">RDMORT</span>: Renal Disease Mortality
|             **[D.1.5]** <span style="color: #FF0000">DBMORT</span>: Diabetes Mortality
|      **[D.2]** Factor 2 was a latent factor describing **Tobacco Use** with higher loadings toward the following descriptors:
|             **[D.2.1]** <span style="color: #FF0000">SMPREV</span>: Smoking Prevalence
|             **[D.2.2]** <span style="color: #FF0000">PDMORT</span>: Pulmonary Disease Mortality
|             **[D.2.3]** <span style="color: #FF0000">ARTINC</span>: Arthritis Incidence
|      **[D.3]** Factor 3 was a latent factor describing **Poor Mental Health** with higher loading towards the following descriptors:
|             **[D.3.1]** <span style="color: #FF0000">MEUNDA</span>: Mentally Unhealthy Days
|
|
...
|      **[A.1]** Factor 1 <span style="color: #FF0000">UNHLIF</span> was a latent factor describing **Unhealthy Lifestyle** with higher loadings toward the following descriptors:
...
|      **[A.2]** Factor 2 <span style="color: #FF0000">PINACT</span> was a latent factor describing **Physical Inactivity** with higher loadings toward the following descriptors:
...
|      **[A.3]** Factor 3 <span style="color: #FF0000">PNUTRI</span> was a latent factor describing **Poor Nutrition** with higher loadings toward the following descriptors:
...
|      **[A.4]** Factor 4 <span style="color: #FF0000">TOBUSE</span> was a latent factor describing **Tobacco Use** with higher loadings toward the following descriptors:
...
|      **[A.2]** Factor 2 <span style="color: #FF0000">TOBUSE</span> was a latent factor describing **Tobacco Use** with higher loadings toward the following descriptors:
...
|      **[A.3]** Factor 3 <span style="color: #FF0000">POMENT</span> was a latent factor describing **Poor Mental Health** with higher loading towards the following descriptors:
...
```{r section_1.3.8, warning=FALSE, message=FALSE, fig.width=15, fig.height=3}
##################################
# Consolidating the fit indices
...
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_37/images/summary_0.png)
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_37/images/summary_1.png)
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_37/images/summary_2.png)
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_37/images/summary_3.png)
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_37/images/summary_4.png)
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_37/images/summary_5.png)
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_37/images/summary_6.png)
|
# **3. References**
|
...
| **[Book]** [Innovative Nursing Care](https://www.degruyter.com/document/doi/10.1515/9783110786088-fm/html) by KlavdijaČuček Trifkovič, Mateja Lorber, Nataša Mlinar Reljić and Gregor Štiglic
...
| **[R Package]** [tidyverse](https://www.tidyverse.org/packages/) by hadley Wickham
| **[R Package]** [lavaan](https://cran.r-project.org/web/packages/lavaan/lavaan.pdf) by Yves Rosseel
| **[R Package]** [semPlot](https://cran.r-project.org/web/packages/semPlot/semPlot.pdf) by Sacha Epskamp
| **[R Package]** [semoutput](https://dr-jt.github.io/semoutput/) by Jason Tsukahara
| **[R Package]** [sjPlot](https://cran.r-project.org/web/packages/sjPlot/sjPlot.pdf) by Daniel Lüdecke
| **[R Package]** [GPArotation](https://cran.r-project.org/web/packages/GPArotation/GPArotation.pdf) by  Coen Bernaards
| **[R Package]** [semTools](https://cran.r-project.org/web/packages/semTools/semTools.pdf) by Terrence Jorgensen
