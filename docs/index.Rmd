...
|      **[A.1]** <span style="color: #FF0000">ALC2_2</span> (character): **Binge Drinking Prevalence**; Binge drinking prevalence among adults aged >= 18 years.
|      **[A.2]** <span style="color: #FF0000">ALC6_0</span> (character): **Liver Disease Mortality**; Chronic liver disease mortality.
|
| **[B]** **Chronic Disease Topic Area : Arthritis**
|      **[B.1]** <span style="color: #FF0000">ART1_1</span> (character): **Arthritis Incidence**; Arthritis among adults aged >= 18 years.
|
| **[C]** **Chronic Disease Topic Area : Asthma**
|      **[C.1]** <span style="color: #FF0000">AST1_1</span> (character): **Asthma Prevalence**; Current asthma prevalence among adults aged >= 18 years.
|      **[C.2]** <span style="color: #FF0000">AST4_1</span> (character): **Asthma Mortality**; Asthma mortality rate.
|
| **[D]** **Chronic Disease Topic Area : Cancer**
|      **[D.1]** <span style="color: #FF0000">CAN1_0</span> (character): **Mammography Use**; Mammography use among women aged 50-74 years.
|      **[D.2]** <span style="color: #FF0000">CAN2_1</span> (character): **Papanicolaou Smear Use**; Papanicolaou smear use among adult women aged 21-65 years.
|      **[D.3]** <span style="color: #FF0000">CAN3_0</span> (character): **Colon Cancer Test Use**; Fecal occult blood test, sigmoidoscopy, or colonoscopy among adults aged 50-75 years.
|
| **[E]** **Chronic Disease Topic Area : Chronic Kidney Disease**
|      **[E.1]** <span style="color: #FF0000">CKD1_0</span> (character): **Renal Disease Mortality**; Mortality with end-stage renal disease.
|      **[E.2]** <span style="color: #FF0000">CKD3_0</span> (character): **Kidney Disease Prevalence**; Prevalence of chronic kidney disease among adults aged >= 18 years.
|
| **[F]** **Chronic Disease Topic Area : Chronic Obstructive Pulmonary Disease**
|      **[F.1]** <span style="color: #FF0000">COPD1_1</span> (character): **Pulmonary Disease Mortality**; Mortality with chronic obstructive pulmonary disease as underlying cause among adults aged >=45 years.
|      **[F.2]** <span style="color: #FF0000">COPD2_0</span> (character): **Pulmonary Disease Prevalence**; Prevalence of chronic obstructive pulmonary disease among adults >= 18.
|      **[F.3]** <span style="color: #FF0000">COPD3_0</span> (character): **Smoking Prevalence**; Prevalence of current smoking among adults >= 18 with diagnosed chronic obstructive pulmonary disease.
|
| **[G]** **Chronic Disease Topic Area : Cardiovascular Disease**
|      **[G.1]** <span style="color: #FF0000">CVD1_1</span> (character): **Cardiovascular Disease Mortality**; Mortality from total cardiovascular disease.
|      **[G.2]** <span style="color: #FF0000">CVD1_2</span> (character): **Heart Disease Mortality**; Mortality from diseases of the heart.
|      **[G.3]** <span style="color: #FF0000">CVD1_5</span> (character): **Cardiovascular Disease Mortality**; Mortality from cerebrovascular disease (stroke).
|
| **[H]** **Chronic Disease Topic Area : Diabetes**
|      **[H.1]** <span style="color: #FF0000">DIA1_1</span> (character): **Diabetes Mortality**; Mortality due to diabetes reported as any listed cause of death.
|      **[H.2]** <span style="color: #FF0000">DIA2_1</span> (character): **Diabetes Prevalence**; Prevalence of diagnosed diabetes among adults aged >= 18 years.
|
| **[I]** **Chronic Disease Topic Area : Immunization**
|      **[I.1]** <span style="color: #FF0000">IMM1_0</span> (character): **Influenza Vaccination**; Influenza vaccination among noninstitutionalized adults aged >= 18 years.
|
| **[J]** **Chronic Disease Topic Area : Mental Health**
|      **[I.1]** <span style="color: #FF0000">MTH1_0</span> (character): **Mentally Unhealthy Days**; Recent mentally unhealthy days among adults aged >= 18 years.
|
| **[K]** **Chronic Disease Topic Area : Nutrition, Physical Activity and Weight Status**
|      **[K.1]** <span style="color: #FF0000">NPAW10_0</span> (character): **Physical Activity**; No leisure-time physical activity among adults aged >= 18 years.
|      **[K.2]** <span style="color: #FF0000">NPAW2_1</span> (character): **Overweight Incidence**; Overweight or obesity among adults aged >= 18 years.
|
| **[L]** **Chronic Disease Topic Area : Oral Health**
|      **[L.1]** <span style="color: #FF0000">ORH1_1</span> (character): **Dentist Visit**; Visits to dentist or dental clinic among adults aged >= 18 years.
|      **[L.2]** <span style="color: #FF0000">ORH4_3</span> (character): **Tooth Loss**; No tooth loss among adults aged 18-64 years.
|
| **[M]** **Chronic Disease Topic Area : Overarching Conditions**
|      **[M.1]** <span style="color: #FF0000">OVC1_1</span> (character): **Health Insurance**; Current lack of health insurance among adults aged 18-64 years.
|      **[M.2]** <span style="color: #FF0000">OVC6_1</span> (character): **Health Status**; Fair or poor self-rated health status among adults aged >= 18 years.
|      **[M.3]** <span style="color: #FF0000">OVC8_0</span> (character): **Sleep Status**; Prevalence of sufficient sleep among adults aged >= 18 years.
|
| **[N]** **Chronic Disease Topic Area : Tobacco**
|      **[N.1]** <span style="color: #FF0000">TOB1_2</span> (character): **Smoking Prevalence**; Current smoking among adults aged >= 18 years.
|      **[N.2]** <span style="color: #FF0000">TOB11_1</span> (character): **Pneumococcal Vaccination**; Pneumococcal vaccination among noninstitutionalized adults aged 18-64 years who smoke.
|      **[N.3]** <span style="color: #FF0000">TOB3_0</span> (character): **Quit Attempts**; Quit attempts in the past year among current smokers.
|
##  1.2 Methodology
|
