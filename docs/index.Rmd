...
|
| [Tucker Lewis Index](https://www.amazon.sg/Exploratory-Confirmatory-Factor-Analysis-Understanding/dp/1591470935) (TLI) assesses the goodness of fit of a proposed confirmatory factor analysis model to the observed data by comparing the fit of the specified model with the fit of a baseline model. The metric is more preferred for smaller sample sizes. The formula involves computing the ratio of the improvement in fit from the proposed model to the fit of the null model. Values range between 0 and 1 with higher measurements indicating a better model fit.
|
| [Comparative Fit Index](https://www.amazon.sg/Exploratory-Confirmatory-Factor-Analysis-Understanding/dp/1591470935) (CFI) assesses the goodness of fit of a proposed confirmatory factor analysis model to the observed data by comparing the fit of the specified model with the fit of a baseline model. The metric is more robust against different sample sizes. The formula involves computing the ratio of the improvement in fit from the proposed model to the fit of the null model. The metric values range between 0 and 1 with higher measurements indicating a better model fit.
|
...
|      **[A.1]** <span style="color: #FF0000">PDMORT</span> = 0.15
|      **[A.2]** <span style="color: #FF0000">DBMORT</span> = 0.35
|      **[A.3]** <span style="color: #FF0000">STMORT</span> = 0.56
|      **[A.4]** <span style="color: #FF0000">HDMORT</span> = 0.47
|      **[A.5]** <span style="color: #FF0000">RDMORT</span> = 0.59
|
...
|
| **[A]** All pairwise correlations among descriptors were positive with values ranging from 0.28 to 0.82 . 
|
|
...
|
| **[B]** No difference was observed for the exploratory factor analysis models applying **Varimax** and **Promax** rotation, although **Varimax** rotation was selected for the improved interpretability of the extracted formulated loadings.
|
...
CFA_4F <- 'UNHLIF =~ HDMORT + STMORT + OVWINC
           ...
           PNUTRI =~ MEUNDA + ARTINC
           PINACT =~ RDMORT + DBMORT'
...
|             **[A.1.2]** <span style="color: #FF0000">STMORT</span>: Stroke Mortality
|             **[A.1.3]** <span style="color: #FF0000">OVWINC</span>: Overweight Incidence
|             **[A.1.4]** <span style="color: #FF0000">MEUNDA</span>: Mentally Unhealthy Days
|             **[A.1.5]** <span style="color: #FF0000">ARTINC</span>: Arthritis Incidence
|      **[A.2]** Factor 2 was a latent factor describing **Poor Nutrition** with higher loading towards the following descriptors:
|             **[A.2.1]** <span style="color: #FF0000">RDMORT</span>: Renal Disease Mortality
|             **[A.2.2]** <span style="color: #FF0000">DBMORT</span>: Diabetes Mortality
|      **[A.3]** Factor 3 was a latent factor describing **Tobacco Use** with higher loading towards the following descriptors:
|             **[A.3.1]** <span style="color: #FF0000">SMPREV</span>: Smoking Prevalence
|             **[A.3.2]** <span style="color: #FF0000">PDMORT</span>: Pulmonary Disease Mortality
|
| **[B]** The **3-Factor Model** demonstrated sufficiently good fit based on the model performance metrics as follows:
|      **[B.1]** Comparative Fit Index = 0.95 (Ideal Criterion: >0.90)
|      **[B.2]** Tucker Lewis Index = 0.93 (Ideal Criterion: >0.90)
|      **[B.3]** Standardized Root Mean Square of the Residual = 0.05 (Ideal Criterion: <0.08)
|      **[B.4]** Root Mean Square Error of Approximation = 0.11 (Ideal Criterion: <0.08)
|
...
|      **[D.1]** **Poor Nutrition** Cronbach's Alpha = 0.88
|      **[D.2]** **Tobacco Use** = 0.85
|      **[D.3]** **Unhealthy Lifestyle** Cronbach's Alpha = 0.89
|
|
