...
##################################
MICE_Model <- mice(DQA.Descriptors.Numeric, method='pmm', seed = 88888888)
...
##################################
(DPA_Correlation <- cor(DQA.Descriptors.Numeric,
                        method = "pearson",
                        use="pairwise.complete.obs"))

DPA_CorrelationTest <- cor.mtest(DQA.Descriptors.Numeric,
                       method = "pearson",
                       conf.level = 0.95)

corrplot(cor(DQA.Descriptors.Numeric,
             method = "pearson",
             use="pairwise.complete.obs"),
             method = "circle",
             type = "upper",
...
(DPA_AllPairs <- length(DQA.Descriptors.Numeric)*(length(DQA.Descriptors.Numeric)-1)/2)

(DPA_MinimallyCorrelatedCountPercentage <- DPA_MinimallyCorrelatedCount/DPA_AllPairs)

qgraph(cor(DQA.Descriptors.Numeric),
       cut=0.30,
       details=TRUE,
       posCol="#2F75B5",
       negCol="#FF5050",
       labels=names(DQA.Descriptors.Numeric))
