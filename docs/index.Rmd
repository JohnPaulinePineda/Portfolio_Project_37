...
##################################
fitMeasures(CFA_4F_MODEL, c("cfi"))
...
##################################
fitMeasures(CFA_4F_MODEL, c("tli"))
...
##################################
fitMeasures(CFA_4F_MODEL, c("srmr"))
...
# (Ideal Criterion: CFI>0.90)
##################################
fitMeasures(CFA_3F_MODEL, c("cfi"))
...
# (Ideal Criterion: TLI>0.90)
##################################
fitMeasures(CFA_3F_MODEL, c("tli"))
...
# (Ideal Criterion: SRMR<0.08)
##################################
fitMeasures(CFA_3F_MODEL, c("srmr"))
