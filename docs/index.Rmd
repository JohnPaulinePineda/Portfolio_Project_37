...
|      **[D.2]** Factor 2 was a latent factor describing **Tobacco Use** with higher loading towards the following descriptors:
...
|      **[A.1]** Factor 1 <span style="color: #FF0000">UNHLIF</span> was a latent factor describing **Unhealthy Lifestyle** with higher loading towards the following descriptors:
...
|      **[A.2]** Factor 2 <span style="color: #FF0000">PINACT</span> was a latent factor describing **Physical Inactivity** with higher loading towards the following descriptors:
...
|      **[A.3]** Factor 3 <span style="color: #FF0000">PNUTRI</span> was a latent factor describing **Poor Nutrition** with higher loading towards the following descriptors:
...
|      **[A.4]** Factor 4 <span style="color: #FF0000">TOBUSE</span> was a latent factor describing **Tobacco Use** with higher loading towards the following descriptors:
...
|      **[A.2]** Factor 2 <span style="color: #FF0000">TOBUSE</span> was a latent factor describing **Tobacco Use** with higher loading towards the following descriptors:
