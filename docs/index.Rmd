...
|
| **[B]**  The sampling adequacy for each variable in the model was acceptable with KMO values ranging from 0.83 to 0.93. Results indicated that each variable can be sufficiently predicted by other variables. 
|      **[B.1]** <span style="color: #FF0000">RDMORT</span> = 0.93
|      **[B.2]** <span style="color: #FF0000">DBMORT</span> = 0.92
|      **[B.3]** <span style="color: #FF0000">HLTSTA</span> = 0.92
|      **[B.4]** <span style="color: #FF0000">DBPREV</span> = 0.89
|      **[B.5]** <span style="color: #FF0000">PDPREV</span> = 0.89
|      **[B.6]** <span style="color: #FF0000">TTHLOSS</span> = 0.88
|      **[B.7]** <span style="color: #FF0000">OVWINC</span> = 0.88
|      **[B.8]** <span style="color: #FF0000">DENVIS</span> = 0.88
|      **[B.9]** <span style="color: #FF0000">ARTINC</span> = 0.86
|      **[B.10]** <span style="color: #FF0000">STMORT</span> = 0.85
|      **[B.11]** <span style="color: #FF0000">SMPREV</span> = 0.85
|      **[B.12]** <span style="color: #FF0000">MEUNDA</span> = 0.84
|      **[B.13]** <span style="color: #FF0000">MEUNDA</span> = 0.84
|      **[B.14]** <span style="color: #FF0000">HDMORT</span> = 0.84
|      **[B.15]** <span style="color: #FF0000">BDPREV</span> = 0.84
|      **[B.16]** <span style="color: #FF0000">CCTUSE</span> = 0.83
|      **[B.17]** <span style="color: #FF0000">PHYACT</span> = 0.82
|
|
...
|
|
| **[A]** The pre-processed tabular dataset was comprised of 50 observations and 17 descriptor variables. 
|      **[A.1]** 50 rows (observations)
|      **[A.2]** 17 columns (descriptors)
|             **[A.2.1]** <span style="color: #FF0000">RDMORT</span> (numeric)
|             **[A.2.2]** <span style="color: #FF0000">DBMORT</span> (numeric)
|             **[A.2.3]** <span style="color: #FF0000">HLTSTA</span> (numeric)
|             **[A.2.4]** <span style="color: #FF0000">DBPREV</span> (numeric)
|             **[A.2.5]** <span style="color: #FF0000">PDPREV</span> (numeric)
|             **[A.2.6]** <span style="color: #FF0000">TTHLOSS</span> (numeric)
|             **[A.2.7]** <span style="color: #FF0000">OVWINC</span> (numeric)
|             **[A.2.8]** <span style="color: #FF0000">DENVIS</span> (numeric)
|             **[A.2.9]** <span style="color: #FF0000">ARTINC</span> (numeric)
|             **[A.2.10]** <span style="color: #FF0000">STMORT</span> (numeric)
|             **[A.2.11]** <span style="color: #FF0000">SMPREV</span> (numeric)
|             **[A.2.12]** <span style="color: #FF0000">MEUNDA</span> (numeric)
|             **[A.2.13]** <span style="color: #FF0000">MEUNDA</span> (numeric)
|             **[A.2.14]** <span style="color: #FF0000">HDMORT</span> (numeric)
|             **[A.2.15]** <span style="color: #FF0000">BDPREV</span> (numeric)
|             **[A.2.16]** <span style="color: #FF0000">CCTUSE</span>  (numeric)
|             **[A.2.17]** <span style="color: #FF0000">PHYACT</span> (numeric)
|
|
...
# for each factor
##################################
alpha(DPA.Descriptors.Numeric[,c("HLTSTA","MEUNDA","DBPREV","TTHLOS","BDPREV","PDPREV","HDMORT","PHYACT")],
      check.keys=TRUE)
...
# for each factor
##################################
alpha(DPA.Descriptors.Numeric[,c("SMPREV","ARTINC","RDMORT","OVWINC","PDMORT","DBMORT","STMORT")],
      check.keys=TRUE)
...
# for each factor
##################################
alpha(DPA.Descriptors.Numeric[,c("CCTUSE","DENVIS")],
      check.keys=TRUE)
